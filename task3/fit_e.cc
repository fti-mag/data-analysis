...
void fit_e() {
  ...
  // Fill histogram
  TH1D *h1 = new TH1D("h1","e-",nbin,xmin,xmax);
  tree->Draw("esum>>h1","pid==1");

  TF1 *f1 = new TF1("f1",func_e,xmin,xmax,4);
  f1->SetParameters(3333.0,120.0,80.0,0.2);
  //f1->SetParameters(3000.0,49.0,4.3,-0.2);
